...
//		$.getJSON('http://www.devwarrior.com/tilegame/users/selectedTile/', function(data){selected_tile = data;});
	...
	$('#myCanvas').mousemove(function(e){
		...
		canvaswindow_offset = $('#myCanvasWindow').offset();
		if(
			((canvas_offset.left - mousetracking_difference.x) < canvaswindow_offset.left+25)
			|| (((canvas_offset.left+$('#myCanvas').width) - mousetracking_difference.x) < (canvaswindow_offset.left + $('#myCanvasWindow').width)-25)
